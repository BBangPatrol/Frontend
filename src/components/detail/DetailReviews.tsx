        ...
        {reviews.length > 0 ? (
          <>
            {reviews.slice(0, 3).map((review) => (
              <Review key={review.id} storeId={storeId} reviewId={review.id} starRating={review.rating} userName={review.writerName} content={review.content} date={review.date} likeCount={review.likeCount} isLike={review.isLike} keywords={review.keywords} />
            ))}
